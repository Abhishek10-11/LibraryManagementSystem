<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="BookInventory.aspx.cs" Inherits="LibraryManagementSystem.Admin.BookInventory" %>
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="txtBID" runat="server" placeholder="Book ID"></asp:TextBox>
                   ...
                   <div class="row">
                     <div class="col">
                        ...
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="txtBname" runat="server" placeholder="Book Name"></asp:TextBox>
                        </div>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DrpLanguage" runat="server">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DrpAuthor" runat="server" DataSourceID="SqlDataSource1" DataTextField="author_name" DataValueField="author_name">
                              <asp:ListItem Text="Author1" Value="Author1" />
                           </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:AM_LibraryConnectionString %>" SelectCommand="SELECT [author_name] FROM [author_master_tbl]"></asp:SqlDataSource>
                            </div>
                     </div>
                     <div class="col-md-4">
                        <label>Genre</label>
                        <div class="form-group">
                            <asp:DropDownList class="form-control" ID="DrpGenre" runat="server">
                   ...
                   <div class="row">
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DrpPublisher" runat="server" DataSourceID="SqlDataSource2" DataTextField="Publisher_name" DataValueField="Publisher_name">
                              <asp:ListItem Text="Publisher 1" Value="Publisher 1" />
                           </asp:DropDownList>
                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:AM_LibraryConnectionString %>" SelectCommand="SELECT [Publisher_name] FROM [publisher_master_tbl]"></asp:SqlDataSource>
                        </div>
                     </div>
                       <div class="col-md-4">
                        <label>Edition</label>
         ...
         <div class="col-md-7">
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <asp:GridView class="table table-striped table-bordered" ID="GridBookDetails" runat="server" AutoGenerateColumns="False" DataKeyNames="book_id" DataSourceID="SqlDataSource3">
                            <Columns>
                         ...
                         <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:AM_LibraryConnectionString %>" SelectCommand="SELECT * FROM [book_master_tbl]"></asp:SqlDataSource>
                     </div>
                  </div>
               </div>
            </div>
